@php
    $fetchBlogData = DB::table('blog')->get();
    $i = 1;
@endphp
                    ...
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                data-target=".bs-example-modal-lg">Add New Blog</button>
                ...
                <div class="modal-body">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <form class="" action="{{url('save_blog')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <textarea required class="form-control summernote" name="desc" rows="5"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div>
